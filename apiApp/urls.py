...
urlpatterns = [
    ...
    path("create_checkout_session/", views.initialize_paystack_payment, name="create_checkout_session"),
    ...
    path("check_cart_existence/<str:cart_code>", views.check_cart_existence, name="check_cart_existence"),
